...
$(
  function() {
    if ( map_div_id && centre_lat && centre_long ) {
      ...
      var attrib;
      // If min_lat is set, this is probably a category/locale map; if it's
      // not, this is probably a node map (smaller hence want less text).
      if ( min_lat ) {
        attrib = 'Data, imagery and map information provided by <a href="http://open.mapquest.co.uk" target="_blank">MapQuest</a>, <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> and contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/" target="_blank">CC-BY-SA</a>';
      } else {
        attrib = 'map tiles by <a href="http://open.mapquest.co.uk" target="_blank">MapQuest</a> &amp; <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>, <a href="http://creativecommons.org/licenses/by-sa/2.0/" target="_blank">CC-BY-SA</a>';
      }
